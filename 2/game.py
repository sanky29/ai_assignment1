...
class Game:
	def __init__(self, n, m, mode = 'CUI', time = 120):
		...
		self.driver = webdriver.Chrome(options = options,executable_path='/mnt/c/Users/sanga/Downloads/chromedriver_win32/chromedriver.exe')

		abs_path = os.path.abspath('Cannon.html')
		self.driver.get("file:F:" + abs_path[7:])
