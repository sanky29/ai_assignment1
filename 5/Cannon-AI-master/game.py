...
class Game:
	def __init__(self, n, m, mode = 'CUI', time = 120):
		...
		self.driver = webdriver.Chrome(options = options,executable_path="/mnt/f/sem5/COL333AI/assignments/5/chromedriver_win32/chromedriver.exe")

		abs_path = os.path.abspath('Cannon.html')
		self.driver.get("file:F:"  + abs_path)
